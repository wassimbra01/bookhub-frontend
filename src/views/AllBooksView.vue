...
.modal { background: #fff; border-radius: 20px; width: 100%; max-width: 620px; box-shadow: 0 24px 64px rgba(0,0,0,0.3); position: relative; overflow: hidden; }
...
.modal-cover-wrap { width: 220px; flex-shrink: 0; min-height: 320px; background: #e8d8c0; }
...
.modal-details { padding: 2rem; flex: 1; display: flex; flex-direction: column; gap: 0.4rem; }
.modal-year { font-size: 0.78rem; color: #d4a96a; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; }
.modal-title { font-family: 'Georgia', serif; font-size: 1.5rem; font-weight: 700; color: #3b2a1a; line-height: 1.3; margin-bottom: 0.2rem; }
.modal-author { font-size: 0.95rem; color: #8a6a4a; font-style: italic; margin-bottom: 0.8rem; }

.modal-meta { background: #faf5ee; border-radius: 10px; overflow: hidden; margin: 0.8rem 0; }
.meta-row { display: flex; justify-content: space-between; padding: 0.65rem 1rem; border-bottom: 1px solid #ede4d6; }
...
.btn-fav { margin-top: auto; padding: 0.7rem 1.4rem; border-radius: 8px; border: none; font-family: 'Georgia', serif; font-size: 0.95rem; cursor: pointer; transition: all 0.2s; width: 100%; font-weight: 600; background: #f5ede0; color: #5a3e28; }
